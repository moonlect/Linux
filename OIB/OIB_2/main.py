...
def function(expansion, s0, s1, key, message):
    ...
    print(left_bin_str, right_bin_str)
...
if __name__ == "__main__":
    ...
    while True:
        mode = input("Выберите режим (шифрование - 1 /расшифрование - 2): ").strip().lower()

        if mode != '1' and mode != '2':
            print("Неверный режим. Пожалуйста, выберите 'шифрование - 1' или 'расшифрование - 2'.")
            continue
